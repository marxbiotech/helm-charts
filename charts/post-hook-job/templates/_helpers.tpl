...
Common labels
*/}}
{{- define "post-hook-job.labels" -}}
helm.sh/chart: {{ include "post-hook-job.chart" . }}
{{ include "post-hook-job.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "post-hook-job.selectorLabels" -}}
app.kubernetes.io/name: {{ include "post-hook-job.name" . }}
